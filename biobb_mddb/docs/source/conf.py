...
htmlhelp_basename = 'biobb_mddb_doc'
...
latex_documents = [
    (master_doc, 'biobb_mddb.tex', u'biobb_mddb Documentation',
...
man_pages = [
    (master_doc, 'biobb_mddb', u'biobb_mddb Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_mddb', u'biobb_mddb Documentation',
     author, 'biobb_mddb', 'biobb_mddb building block',
     'Miscellaneous'),
]
